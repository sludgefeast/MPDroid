...
public class ServiceBinder implements
    ...
    /**
     * Initiates our unbinding from the bound service, after complete, onServiceDisconnected()
     * should be called.
     */
    ...
    /**
     * The method which actually sends the message generated by the other sendMessageToService
     * methods.
     *
